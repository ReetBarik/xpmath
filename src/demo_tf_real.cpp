// Kokkos triple-float demo — real ops. TIMING AND SMOKE ONLY.
// Times Kokkos::Experimental::TripleFloat against FP64, op by op.
//
...
struct OpResult { Op op; TimeStats tf_timing, dbl_timing; };
