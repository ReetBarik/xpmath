#!/usr/bin/env bash
# ============================================================================
# gfx90a branch-reach guard for xpmath.
#
...
#
# Exit: 0 clean (warnings allowed), 1 tier-1 or tier-3 FATAL, 2 bad invocation.
# ============================================================================
set -uo pipefail
...
for s in "${asms[@]}"; do
  ...
  awk '$1=="callee"{c++; if($2+0>m){m=$2; mn=$5}} $1=="KERNEL"{k++; if($2+0>km)km=$2}
