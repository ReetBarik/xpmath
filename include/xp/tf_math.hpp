...
// Auto-generated by splitting __float128 literals (Route-A, length-3).
// See scripts/gen_tf_constants.cpp (to be written).
// ============================================================
XPMATH_INLINE_FUNCTION TripleFloat TripleFloat_pi() {
    return TripleFloat::from_bits(0x40490fdbU, 0xb3bbbd2eU, 0x33a22169U);
}
XPMATH_INLINE_FUNCTION TripleFloat TripleFloat_e() {
    return TripleFloat::from_bits(0x402df854U, 0x33b14577U, 0x32328cc0U);
}
XPMATH_INLINE_FUNCTION TripleFloat TripleFloat_log2() {
    return TripleFloat::from_bits(0x3f317218U, 0xb102e308U, 0xb27f1f10U);
}
XPMATH_INLINE_FUNCTION TripleFloat TripleFloat_log10() {
    return TripleFloat::from_bits(0x40135d8eU, 0xb309555dU, 0x32c99f92U);
}
XPMATH_INLINE_FUNCTION TripleFloat TripleFloat_sqrt2() {
    return TripleFloat::from_bits(0x3fb504f3U, 0x32cfe77aU, 0xb2354dd2U);
}
XPMATH_INLINE_FUNCTION TripleFloat TripleFloat_euler_gamma() {
    return TripleFloat::from_bits(0x3f13c468U, 0xb1e4127aU, 0x3101ea9fU);
}
...
XPMATH_INLINE_FUNCTION TripleFloat sloppy_add(TripleFloat a, TripleFloat b) {
    float s0, s1, s2;
    s0 = tf_two_sum(a.f0, b.f0, s1);
    s2 = tf_two_sum(a.f1, b.f1, s2);
    s1 += s2;
    s2 = a.f2 + b.f2;
    tf_three_sum(s0, s1, s2);
...
XPMATH_INLINE_FUNCTION TripleFloat ieee_add(TripleFloat a, TripleFloat b) {
    ...
    while (k < 3) {
        ...
        s = tf_quick_two_sum(u, t, t);
        u = tf_quick_two_sum(s, v, v);
        v = v + t;
...
// Sloppy multiplication. Port of qd::sloppy_mul (qd_inline.h:407-459),
// specialized to k=3. Natural output width is 4 words; collapsed to 3 via renorm_3.
XPMATH_INLINE_FUNCTION TripleFloat multiply(TripleFloat a, TripleFloat b) {
    float p0, p1, p2, p3;
    float q0, q1, q2, q3;
    float s0, s1, s2;
    ...
    p2 = tf_two_sum(p2, q0, q0);

    s0 = p0;
    s1 = p1;
    s2 = p2;

    s1 = tf_two_sum(s1, q1, t0);
    s2 = tf_two_sum(s2, t0, t0);

    s2 = tf_two_sum(s2, q2, t0);
    s2 += a.f0 * b.f2 + a.f1 * b.f1 + a.f2 * b.f0;

    p3 = q0 + s2;
    renorm_3(s0, s1, p2, p3);
    return TripleFloat(s0, s1, p2);
}
...
// Multiplication by scalar. Derived from multiply() by replacing b.f1, b.f2
// with zeros. Natural output is 4 words; collapsed via renorm_3.
XPMATH_INLINE_FUNCTION TripleFloat multiply_scalar(TripleFloat a, float b) {
    float p0, p1, p2;
    float q0, q1;
    float s0, s1, s2, p3;

    p0 = tf_two_prod(a.f0, b, q0);
    p1 = tf_two_prod(a.f1, b, q1);
    ...
    p2 = a.f2 * b;
    p3 = q0 + s2 + p2;
    renorm_3(s0, s1, s2, p3);
    return TripleFloat(s0, s1, s2);
}

// Squaring. Port of qd::sqr (qd_inline.h:461-513), specialized to k=3.
XPMATH_INLINE_FUNCTION TripleFloat sqr(TripleFloat a) {
    float p0, p1, p2, p3;
    float q0, q1, q2, q3;
    float s0, s1;
    ...
    p2 = tf_two_sqr(a.f1, q2);

    p1 = tf_two_sum(q0, p1, q0);
    q0 = tf_two_sum(q0, q1, q1);
    p2 = tf_two_sum(p2, q0, t0);
    ...
    s1 = tf_two_sum(s1, q1, t0);
    s1 = tf_two_sum(s1, p2, t0);

    p3 = p3 + 2.0f * a.f1 * a.f2 + q2 + t0;
    renorm_3(s0, s1, p2, p3);
    return TripleFloat(s0, s1, p2);
}
...
XPMATH_INLINE_FUNCTION TripleFloat divide(TripleFloat a, TripleFloat b) {
    ...
    float s0, s1, s2, s3;
    s0 = tf_quick_two_sum(q0, q1, s1);
    tf_three_sum(s0, s1, q2);

    s2 = s1;
    s3 = q2;
    renorm_3(s0, s2, s3, s1);
    return TripleFloat(s0, s2, s3);
}
...
XPMATH_INLINE_FUNCTION TripleFloat divide_scalar(TripleFloat a, float b) {
    ...
    q0 = a.f0 / b;
    float p0, e0;
    p0 = tf_two_prod(q0, b, e0);
    r = subtract(a, TripleFloat(p0, e0, 0.0f));

    q1 = r.f0 / b;
    float p1, e1;
    p1 = tf_two_prod(q1, b, e1);
    r = subtract(r, TripleFloat(p1, e1, 0.0f));
