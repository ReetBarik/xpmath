...
XPMATH_INLINE_FUNCTION TripleFloatComplex asin(TripleFloatComplex z) {
    ...
    const TripleFloat re = atan2(sum.im, sum.re);
    ...
    TripleFloat im = xp_asin_imag_mag(xp_abs_word(z.re), xp_abs_word(z.im));
...
XPMATH_INLINE_FUNCTION TripleFloatComplex acosh(TripleFloatComplex z) {
    ...
    // [-1,1], so at z = 0.5 + 1e-30i it scored 0.00 of 21.70. The imaginary part
    ...
    TripleFloat im_ = multiply_scalar(lg.im, 2.0f);
