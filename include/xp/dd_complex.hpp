...
XPMATH_INLINE_FUNCTION DoubleDoubleComplex asin(DoubleDoubleComplex z) {
    ...
    const DoubleDouble re = atan2(sum.im, sum.re);
    ...
    DoubleDouble im = xp_asin_imag_mag(xp_abs_word(z.re), xp_abs_word(z.im));
...
XPMATH_INLINE_FUNCTION DoubleDoubleComplex acosh(DoubleDoubleComplex z) {
    ...
    // [-1,1], so at z = 0.5 + 1e-30i it scored 1.19 of 31.00. The imaginary part
    ...
    DoubleDouble im_ = multiply_scalar(lg.im, 2.0);
