...
| `round` | QF | 29.00 | 28.86 | 6.55 .. 1e+30 | 100% | below 6.5: 0.85 | 8 | UNEXPLAINED (**8 unexplained**) |
| `round` | TF | 21.70 | 21.60 | 6.55 .. 1e+30 | 100% | below 6.5: 0.85 | 8 | UNEXPLAINED (**8 unexplained**) |
| `round` | FF | 14.00 | 13.93 | 6.55 .. 1e+30 | 100% | below 6.5: 0.85 | 8 | UNEXPLAINED (**8 unexplained**) |
...
- `round` — DD 8 pts (linear sweep over [-8, 8]); QF 8 pts (linear sweep over [-8, 8]); TF 8 pts (linear sweep over [-8, 8]); FF 8 pts (linear sweep over [-8, 8])
...
| `div` | QF | 29.00 | 25.86 | 1e-13 .. 1e-10 | 77% | below 1e-15: 10.44; above 1e-08: 11.73 | 160 | UNEXPLAINED (**142 unexplained**) |
| `div` | TF | 21.70 | 19.82 | 1e-14 .. 1e-09 | 84% | below 1e-15: 10.44; above 1e-08: 7.24 | 163 | UNEXPLAINED (**153 unexplained**) |
| `div` | FF | 14.00 | 12.41 | 0.99 .. 1 | 88% | below 0.99: 0.00; above 1: 0.00 | 197 | CONDITIONING (**17 unexplained**) |
...
- `div` — DD 7 pts (polar shells); QF 160 pts (perpendicular approach to the real axis); TF 163 pts (perpendicular approach to the real axis); FF 197 pts (perpendicular approach to the real axis)
...
| `exp` | QF | 29.00 | 24.60 | 1 .. 2 | 79% | below 1: 13.77; above 2: 13.82 | 219 | OVERFLOW (**26 unexplained**) |
...
| `log` | QF | 29.00 | 24.55 | 2 .. 2.236 | 75% | below 2: 0.00; above 10: 0.00 | 249 | CONDITIONING (**14 unexplained**) |
| `log` | TF | 21.70 | 18.49 | 2 .. 2.236 | 76% | below 2: 0.00; above 10: 0.00 | 220 | CONDITIONING |
...
| `log10` | QF | 29.00 | 24.34 | 2 .. 2.236 | 73% | below 2: 0.00; above 10: 0.00 | 249 | CONDITIONING (**14 unexplained**) |
| `log10` | TF | 21.70 | 18.46 | 2 .. 2.236 | 75% | below 2: 0.00; above 10: 0.00 | 220 | CONDITIONING |
...
| `pow` | TF | 21.70 | 19.80 | 2 .. 2.002 | 89% | below 2: 0.00; above 2.236: 8.92 | 113 | CONDITIONING (**2 unexplained**) |
...
| `cos` | QF | 29.00 | 26.21 | 1 .. 2 | 76% | below 1: 13.77; above 2: 13.77 | 47 | OVERFLOW (**13 unexplained**) |
| `cos` | TF | 21.70 | 20.54 | 1 .. 2 | 87% | above 1e+04: 0.00 | 42 | OVERFLOW |
| `cos` | FF | 14.00 | 13.32 | 0 .. 100 | 95% | above 1e+04: 0.00 | 58 | OVERFLOW |
| `tan` | DD | 31.00 | 30.51 | 0 .. 1e+04 | 97% | above 1e+04: 0.00 | 12 | UNEXPLAINED (**12 unexplained**) |
| `tan` | QF | 29.00 | 26.01 | 1 .. 2 | 72% | below 1: 13.84; above 10: 13.31 | 56 | UNEXPLAINED (**52 unexplained**) |
| `tan` | TF | 21.70 | 20.49 | 1e-27 .. 0.1 | 85% | above 10: 10.52 | 48 | UNEXPLAINED (**32 unexplained**) |
| `tan` | FF | 14.00 | 13.42 | 0 .. 2.236 | 94% | above 1e+04: 0.00 | 40 | OVERFLOW (**12 unexplained**) |
...
| `cosh` | QF | 29.00 | 23.73 | 1 .. 2 | 70% | below 1: 13.77; above 2: 13.77 | 232 | OVERFLOW (**17 unexplained**) |
| `cosh` | TF | 21.70 | 18.62 | 1 .. 2 | 80% | above 100: 0.00 | 215 | OVERFLOW |
| `cosh` | FF | 14.00 | 12.22 | 0 .. 10.05 | 88% | above 100: 0.00 | 215 | OVERFLOW |
| `tanh` | DD | 31.00 | 30.55 | 0 .. 1000 | 99% | above 1e+04: 0.00 | 12 | UNEXPLAINED (**12 unexplained**) |
| `tanh` | QF | 29.00 | 24.47 | 1 .. 2 | 72% | below 1: 13.84; above 10: 13.31 | 178 | UNEXPLAINED (**178 unexplained**) |
| `tanh` | TF | 21.70 | 19.27 | 1e-27 .. 0.1 | 82% | above 10: 10.52 | 156 | UNEXPLAINED (**156 unexplained**) |
| `tanh` | FF | 14.00 | 12.71 | 0 .. 2.236 | 91% | above 100: 0.00 | 136 | UNEXPLAINED (**136 unexplained**) |
...
| `asin` | QF | 29.00 | 27.64 | 10 .. 1e+15 | 87% | below 10: 13.77 | 20 | UNEXPLAINED (**20 unexplained**) |
| `asin` | TF | 21.70 | 21.30 | 10 .. 1e+15 | 94% | -- | 0 | -- |
| `asin` | FF | 14.00 | 13.90 | 1.005 .. 1e+15 | 98% | -- | 0 | -- |
| `acos` | DD | 31.00 | 30.81 | 0 .. 1e+04 | 99% | -- | 0 | -- |
| `acos` | QF | 29.00 | 27.86 | 1 .. 2 | 90% | below 1: 14.49; above 2: 14.12 | 14 | UNEXPLAINED (**12 unexplained**) |
...
| `atan` | QF | 29.00 | 27.80 | 1 .. 2 | 88% | below 1e-30: 13.95; above 10: 13.51 | 20 | UNEXPLAINED (**20 unexplained**) |
| `atan` | TF | 21.70 | 21.35 | 1e-28 .. 0.1 | 95% | -- | 0 | -- |
| `atan` | FF | 14.00 | 13.96 | 0 .. 10.05 | 100% | -- | 0 | -- |
| `asinh` | DD | 31.00 | 30.96 | 0 .. 1e+15 | 100% | -- | 0 | -- |
| `asinh` | QF | 29.00 | 27.32 | 1 .. 2 | 84% | below 1: 14.10; above 2: 14.46 | 36 | UNEXPLAINED (**36 unexplained**) |
| `asinh` | TF | 21.70 | 21.21 | 1e-27 .. 0.1 | 92% | -- | 0 | -- |
| `asinh` | FF | 14.00 | 13.94 | 0 .. 10.05 | 100% | -- | 0 | -- |
| `acosh` | DD | 31.00 | 30.89 | 0 .. 1e+15 | 100% | -- | 0 | -- |
| `acosh` | QF | 29.00 | 27.94 | 1 .. 2 | 91% | above 2: 14.12 | 12 | UNEXPLAINED (**12 unexplained**) |
| `acosh` | TF | 21.70 | 21.40 | 1e-28 .. 0.1 | 96% | -- | 0 | -- |
| `acosh` | FF | 14.00 | 13.82 | 1.005 .. 10.05 | 98% | -- | 0 | -- |
| `atanh` | DD | 31.00 | 30.99 | 0 .. 1e+15 | 100% | -- | 0 | -- |
| `atanh` | QF | 29.00 | 27.86 | 10 .. 1e+04 | 90% | below 10: 13.51 | 26 | CONDITIONING (**10 unexplained**) |
